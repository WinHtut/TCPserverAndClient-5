...
class TCPserver():
    ...
    def handle_client(self,client_socket):
        with client_socket as sock:
            ...
            #To Decompress
            gene="Hello"
            toCompressed : Compressed =Compressed(gene, DecryptedData)
            DecompressedData=toCompressed.decompress()
            ...
            DB_Compress : Compressed =Compressed(backDataFromDB,123)

            print("Compressed Data From DB",DB_Compress.bit_string)

            #to Encrypt

            objEncrypt = Encrypt()
            CypherText, Key = objEncrypt.encrypt(str(DB_Compress)) #will get int type
